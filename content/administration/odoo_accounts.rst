...
such as adding a client database to an Odoo.com account, how to delete an Odoo.com account, how to
reset an Odoo.com account password, and how to add two-factor authentication.
...
sent to the email address. Once confirmed, the database now appears in the **My Databases** page of
the account.
...
.. example::
   ...
   page, but 'Stealthy Wood' was created by Mitchell Admin. To add the account, a user with
   administrator access of 'Stealthy Wood' adds Deco Addict as a user of 'Stealthy Wood'.
   Now when Deco Addict visits their 'My Databases' page, 'Stealthy Wood' appears.
